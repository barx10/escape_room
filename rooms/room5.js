    ...
    <div style="background: rgba(0,0,0,0.4); padding: 20px; border-radius: 10px; margin: 20px 0; border: 2px solid #00ff41;">
        ...
        <div style="margin: 15px 0;">
            ...
            <div style="display: flex; gap: 10px; align-items: center; margin-top: 10px;">
                ...
                <button class="btn-small" id="btn-q1" onclick="checkAnswer5(1)">Sjekk svar ✓</button>
            </div>
        </div>
        ...
        <div style="margin: 15px 0;">
            ...
            <div style="display: flex; gap: 10px; align-items: center; margin-top: 10px;">
                ...
                <button class="btn-small" id="btn-q2" onclick="checkAnswer5(2)">Sjekk svar ✓</button>
            </div>
        </div>
        ...
        <div style="margin: 15px 0;">
            ...
            <div style="display: flex; gap: 10px; align-items: center; margin-top: 10px;">
                ...
                <button class="btn-small" id="btn-q3" onclick="checkAnswer5(3)">Sjekk svar ✓</button>
            </div>
        </div>
        ...
        <div style="margin: 15px 0;">
            ...
            <div style="display: flex; gap: 10px; align-items: center; margin-top: 10px;">
                ...
                <button class="btn-small" id="btn-q4" onclick="checkAnswer5(4)">Sjekk svar ✓</button>
            </div>
        </div>
    </div>

    <button class="btn" onclick="checkRoom5()">Verifiser svar 🔍</button>
    `,
    function check() {
        return true; // Handled by window.checkRoom5
    },
